...
public class TownyExternalPluginLoader implements PluginLoader {
    ...
    public void classloader(
        ...
        resolver.addDependency(new Dependency(new DefaultArtifact("com.h2database:h2:2.3.230"), null));
